...
import ociIFMService from '../services/OCIIFMService';

const useOCIIFMReducer = create((set) => ({
    isLoadingGet: false,
    errorMessage: '',
    successMessage: '',
    ociIFMData: null,
    ...
    getData: async (params) => {
        try {
            ...
            const response = await ociIFMService.getData(params);
            const list = response?.data;
            set({   
                ociIFMData: list?.data ?? [],
    ...
    bulkIFM: async (payload, callback) => {
        ...
        try {
            ...
            const response = await ociIFMService.bulkIFM(payload);
...
export default useOCIIFMReducer;
