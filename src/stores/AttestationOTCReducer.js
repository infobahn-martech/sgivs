...
import attestationOTCService from '../services/attestationOTCService';

const useAttestationOTCReducer = create((set) => ({
    isLoadingGet: false,
    errorMessage: '',
    successMessage: '',
    attestationOTCData: null,
    isLoadingPost: false,
    pagination: null,
    ...
    getData: async (params) => {
        try {
            ...
            const { data } = await attestationOTCService.getData(params);
            const list = data;
            set({
                attestationOTCData: list?.data,
    ...
    bulkOTC: async (payload, callback) => {
        ...
        try {
            ...
            const response = await attestationOTCService.bulkOTC(payload);
...
export default useAttestationOTCReducer;
