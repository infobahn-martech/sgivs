...
const OutScan = () => {
  ...
  const { getData, outScanData, isLoadingGet, isLoadingDelete } = useOutScanReducer((state) => state);
    ...
    <>
      ...
      {addEditModal && (
        <AddEditModal
          ...
          onRefreshOutScan={onRefreshOutScan}
        />
      )}
    </>
  );
