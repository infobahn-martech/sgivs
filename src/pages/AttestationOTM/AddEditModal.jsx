...
export default function AddEditModal({ showModal, closeModal, onRefreshAttestationOTM }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const { bulkOTM, isLoadingPost } = useAttestationOTMReducer((state) => state);
    ...
    const renderHeader = () => (
        <>
            <h4 className="modal-title">Add Attestation OutScan to Mission</h4>
            <button
                type="button"
                className="btn-close"
