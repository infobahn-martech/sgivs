...
const AttestationInScan = () => {
  ...
  const { getData, attestationInScanData, isLoadingGet, pagination } = useAttestationInScanReducer((state) => state);
  ...
  const onRefreshAttestationInScan = () => {
    getData(params);
  };
  ...
  const tableData = attestationInScanData || [];
    ...
    <>
      ...
      {addEditModal && (
        <AddEditModal
          ...
          onRefreshAttestationInScan={onRefreshAttestationInScan}
        />
      )}
    </>
  );
