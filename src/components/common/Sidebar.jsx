  ...
  const sideMenu = [
    ...
    // Passport Manager
    {
      ...
      subMenu: [
        ...
        { name: 'Outscanned From Spoke', path: '/outscan-from-spoke', icon: MessagesIcon },
        { name: 'Inscan At Hub', path: '/inscan-at-hub', icon: MessagesIcon },
        { name: 'Out Scan to Mission', path: '/outscan-to-mission', icon: MessagesIcon },
        { name: 'Inscan From Mission', path: '/inscan-from-mission', icon: MessagesIcon },
        { name: 'Out Scan to Spoke', path: '/outscan-to-spoke', icon: MessagesIcon },
        { name: 'Counter Delivery', path: '/counter-delivery', icon: MessagesIcon },
        { name: 'Out Scan to Courier', path: '/outscan-to-courier', icon: MessagesIcon },
    ...
    // OCI Manager
    {
      ...
      activeRoutes: ['/oci-applications', '/oci-deleted-application', '/oci-inscan', '/oci-outscan-to-mission', '/oci-inscan-from-mission', '/oci-outscan-to-spoke', '/oci-counter-delivery', '/oci-outscan-to-courier', '/oci-tracking'],
      subMenu: [
        { name: 'OCI Applications', path: '/oci-applications', icon: MessagesIcon },
        { name: 'Deleted Application', path: '/oci-deleted-application', icon: MessagesIcon },
        ...
        { name: 'Outscan To Courier', path: '/oci-outscan-to-courier', icon: MessagesIcon },
    ...
    // Attestation Manager
    {
      ...
      subMenu: [
        ...
        { name: 'Outscan To Courier', path: '/attestation-outscan-to-courier', icon: MessagesIcon },
        { name: 'Attestation Tracking', path: '/attestation-tracking', icon: MessagesIcon },
      ],
    },
    // Elite Delivery
    {
