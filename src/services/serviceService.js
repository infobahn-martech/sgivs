...
const getServicesByServiceType = (service_type_id) => Gateway.post(`/service/service_by_service_type/${service_type_id}`, { service_type_id });
const deleteData = (id) => Gateway.delete(`/service/delete_service/${id}`);

const getServiceById = (service_id) => Gateway.post('/service/get_service_by_id', { service_id });
